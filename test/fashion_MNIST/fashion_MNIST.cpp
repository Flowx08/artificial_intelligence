...
int main(int argc, const char *argv[])
{
	...
	*/
	...
	gg.push("CONV1",	"INPUT1",		ai::Convolution::make(3, 2 * 10, 1, 1));
	gg.push("NORM1",	"CONV1",		ai::Normalization::make(0.5));
	gg.push("REL1",		"NORM1",		ai::Relu::make());
	...
	gg.push("CONV2",	"MAX",		ai::Convolution::make(3, 2 * 8, 1, 1));
	gg.push("NORM2",	"CONV2",		ai::Normalization::make(0.5));
	gg.push("REL2",		"NORM2",		ai::Relu::make());
	...
	gg.push("CONV3",	"MAX2",		ai::Convolution::make(3, 2 * 8, 1, 1));
	gg.push("NORM3",	"CONV3",		ai::Normalization::make(0.5));
	gg.push("REL3",		"NORM3",		ai::Relu::make());
  ...
  ai::loadMNIST_from_binary(
		"/home/flowx08/fashion_mnist/train-images-idx3-ubyte",
		"/home/flowx08/fashion_mnist/t10k-images-idx3-ubyte",
		"/home/flowx08/fashion_mnist/train-labels-idx1-ubyte",
		"/home/flowx08/fashion_mnist/t10k-labels-idx1-ubyte",
		trainingset, training_targets, testingset, testing_targets);

	//Create optimizer
	ai::OptimizerSDG opt(1, 0.01, 0.5, ai::Cost::CrossEntropy);
